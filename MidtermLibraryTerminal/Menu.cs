...
namespace MidtermLibraryTerminal
{
    class Menu
    {
        ...
        public static void VariantMenuStart(List<VariantOption> options, string prompt)
        {
            int index = 0;
        ...
        public static void VariantWriteMenu(List<Option> options, Option selectedOption, string prompt)
        {
            Console.Clear();
            Console.WriteLine($"{prompt}\n");
